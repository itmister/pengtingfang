...
function strip_array($var) {
    return is_array($var) ? array_map("strip_array", $var) : addslashes(htmlspecialchars($var));
}

function strip_mysql($var){
    return str_replace(array(';','tables','TABLE','TRUNCATE','DROP','drop','SELECT','select','DELETE','delete','UPDATE','update','show','SHOW'),"",$var);
}