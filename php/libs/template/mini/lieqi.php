...
<div class="iframe" id="lieqibox" style="position: relative;">
  <div  id="dowebok">
    <div class="tt-cont">
        <!-- 第一屏 start-->
        <div  class="section">
            ...
            <div class="w355 clearfix">
                <ul class="title_content title_spac">
                    <?php
                    $temp_index = 0;
                    $btype   = "text";
                    foreach($right_news as $key => $news){
                        ...
                        $pdata   = $news['url'].'|'.$newstype.'|'.$category['ename'].'|'.$index.'|'.$btype.'|'.$subtype;
            ...
            <div class="addbox">
                ...
                <?php 
                    foreach ($more_news as $key => $more){
                        ...
                        $pdata = $more['url'].'|'.$newstype.'|'.$category['ename'].'2|'.($key + 4).'|'.$btype.'|'.$subtype;
