...
use \Dao;
class Tn_sub_channel_temp extends \Dao\Huayangnianhua_admin\Huayangnianhua_admin{
    ...
    public function tn_update_is_me(){
        ...
        (SELECT sub_channel,soft_id,tn FROM stat_sub_channel_info where status=0 GROUP BY sub_channel,tn,soft_id) as tp on t.qid=tp.sub_channel and t.soft_id=tp.soft_id and t.tn=tp.tn
