...
use \Dao;
class Install_uuid_qid_pay_only extends Winhome {

    protected static $_instance = null;
    /**
     * @return Dao\Winhome\Install_uuid_qid_pay_only
     */
    ...
    public function get_install_pay_ymd_count($ymd){
        $sql = "select count(*) as num from (
                    ...
                    FROM `{$this->_realTableName}` as a LEFT JOIN wh_online_uuid_qid_pay as b on a.uid=b.uid and a.QID=b.qid
