...
use \Dao;
class Install_uuid_only extends Winhome {

    protected static $_instance = null;
    /**
     * @return Dao\Winhome\Install_uuid_only
     */
    ...
    public function get_install_uninstall_count($ymd){
        $sql = "SELECT count(*) as install_uninstall FROM `{$this->_realTableName}` as a left JOIN wh_uninstall_uuid_only as b on a.uid=b.uid and a.Ymd=b.Ymd
