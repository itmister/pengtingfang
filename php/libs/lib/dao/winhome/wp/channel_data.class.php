...
use \Dao;
class Channel_data extends Wp {

    protected static $_instance = null;
    /**
     * @return Dao\Winhome\Wp\Channel_data
     */
    ...
    public function get_online_count($ymd){
        $sql = "create table temp_channel_qid_online as
                SELECT b.num,b.qid FROM `{$this->_realTableName}` as a LEFT JOIN (
                 SELECT count(*) as num , qid FROM wp_online_uid_channel_qid_temp GROUP BY qid
