...
use \Dao;
class Online_uid_channel_qid_temp extends Wp{

    protected static $_instance = null;
    /**
     * @return Dao\Winhome\Wp\Online_uid_channel_qid_temp
     */
...
FROM `{$this->_realTableName}` as a LEFT JOIN wp_install_uid_channel_qid_only as b on a.uid=b.uid and a.qid=b.QID where a.ymd={$ymd} and b.uid is not null GROUP BY a.qid,b.Ymd;";
