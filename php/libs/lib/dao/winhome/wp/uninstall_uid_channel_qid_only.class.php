...
use \Dao;
class Uninstall_uid_channel_qid_only extends Wp {

    protected static $_instance = null;
    /**
     * @return Dao\Winhome\Wp\Uninstall_uid_channel_qid_only
     */
    ...
    public function get_uninstall_rate($ymd){
        $sql = "SELECT b.Ymd as ymd,a.QID as qid,count( case when TIMESTAMPDIFF(DAY,b.Ymd,a.Ymd)=1 then a.uid end) as uninstall1,
                ...
                FROM `{$this->_realTableName}` as a LEFT JOIN wp_install_uid_channel_qid_only as b on a.uid=b.uid and a.QID=b.QID
