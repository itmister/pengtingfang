...
class Technician_ymd_registerym_credit30 extends Stat {
    /**
     * @return Technician_ymd_registerym_credit30
     */
    ...
    public function create_table() {
        $this->drop();
        $sql = "
            create table `manager_technician_ymd_registerym_credit30` (
                ...
                `ymd` int(11) not null default 0 comment '年月',
                primary key(`manager_uid`, `ymd`),
    ...
    public function sync_all() {
        $this->delete_all();
        $sql = "
            insert into `manager_technician_ymd_registerym_credit30` (manager_uid, director_uid, credit30_count, ymd)
            select
                manager_uid,
                director_uid,
                ...
                reg_ymd
            from
                manager_technician_performance_registerym
            where
                credit >= 30000
            GROUP BY
              manager_uid,reg_ymd
