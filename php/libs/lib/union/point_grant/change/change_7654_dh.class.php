 ...
 * 原始渠道号转换uid
 */
class Change_7654_dh extends Change{
    ...
    /**
     * @return \Union\Point_grant\Change\Change_7654_dh
     */
    ...
    public function get_data_to_vendor_org($softId,$ymd){
        ...
        $data = \Dao\Union\Vendor_Org_Data::get_instance()->select(
            array(
                "where"=>"promotion='{$softId}' and ymd={$ymd} and org_id like '7654dh_%'",
    ...
    public function org_id_change_my_org_id($array){
        ...
        $original_sum = 0;
        foreach($array as $_v){
            $_v['org_id'] = str_replace("7654dh_","",$_v['org_id']);
