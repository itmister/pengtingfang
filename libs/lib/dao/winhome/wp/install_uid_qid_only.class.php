...
use \Dao;
class Install_uid_qid_only extends WP {

    protected static $_instance = null;
    /**
     * @return Dao\Winhome\Wp\Install_uid_qid_only
     */
    ...
    public function get_qid_uninstall_count($ymd){
        ...
        FROM `{$this->_realTableName}` as a LEFT JOIN wp_uninstall_uid_qid_only as b on a.uid=b.uid and a.QID=b.QID and a.Ymd=b.Ymd WHERE a.Ymd={$ymd} and b.Ymd={$ymd} GROUP BY a.QID";
        return $this->query($sql);
    }
}
