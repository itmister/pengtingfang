...
use \Dao;
class Online_uid_channel_qid_temp extends Winhome {

    protected static $_instance = null;
    /**
     * @return Dao\Winhome\Online_uid_channel_qid_temp
     */
    ...
    public function get_online_rate($ymd){
        $sql = "SELECT b.Ymd as ymd,a.qid as qid,count( case when TIMESTAMPDIFF(DAY,b.Ymd,a.ymd)=1 then a.uid end) as online1,
                ...
                FROM `{$this->_realTableName}` as a LEFT JOIN wh_install_uid_channel_qid_only as b on a.uid=b.uid and a.qid=b.QID
