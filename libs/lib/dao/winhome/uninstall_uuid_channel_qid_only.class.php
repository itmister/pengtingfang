...
use \Dao;
class Uninstall_uuid_channel_qid_only extends Winhome {
    ...
    public function get_uninstall_rate($ymd){
        $sql = "SELECT b.Ymd as ymd,a.QID as qid,count( case when TIMESTAMPDIFF(DAY,b.Ymd,a.Ymd)=1 then a.uid end) as uninstall1,
                ...
                FROM `{$this->_realTableName}` as a LEFT JOIN wh_install_uuid_channel_qid_only as b on a.uid=b.uid and a.QID=b.QID
