...
use \Dao;
class Tn_channel_temp extends Winhome{
    ...
    public function tn_update_is_me(){
        ...
        (SELECT channel,soft_id,tn FROM wh_sub_channel_info GROUP BY channel,tn,soft_id) as tp on t.qid=tp.channel and t.soft_id=tp.soft_id and t.tn=tp.tn
