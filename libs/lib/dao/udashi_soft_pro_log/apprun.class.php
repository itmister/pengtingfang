...
use \Dao;
class Apprun extends Udashi_soft_pro_log {

    protected static $_instance = null;
    /**
     * @return Dao\Udashi_soft_pro_log\Apprun
     */
    ...
    public function get_all_online_channel_qid_uuid_count_new($ymd){
        $sql = "SELECT count(DISTINCT UID,substring_index(QID, '_', 1)) as num FROM `{$this->_realTableName}{$ymd}`";
        $data = $this->query($sql);
        return isset($data[0]['num'])&&$data[0]['num']>0 ? $data[0]['num'] : 0;
    }
    ...
    public function get_all_online_channel_qid_uuid_new($ymd,$limit=''){
    ...
    public function get_all_online_qid_uuid_count_new($ymd){
    ...
    public function get_all_online_qid_uuid_new($ymd,$limit=''){
    ...
    public function get_all_online_ver_count($ymd){
        $sql = "SELECT count(DISTINCT Version) as num FROM `{$this->_realTableName}{$ymd}`";
        $data = $this->query($sql);
        return isset($data[0]['num'])&&$data[0]['num']>0 ? $data[0]['num'] : 0;
    }
