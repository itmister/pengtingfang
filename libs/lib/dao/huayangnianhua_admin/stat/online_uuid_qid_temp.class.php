...
use \Dao;
class Online_uuid_qid_temp extends \Dao\Huayangnianhua_admin\Huayangnianhua_admin {

    protected static $_instance = null;
    /**
     * @return Dao\Winhome\Online_uuid_qid_temp
     */
    ...
    public function get_online_rate($ymd){
        $sql = "SELECT b.Ymd as ymd,a.qid as qid,count( case when TIMESTAMPDIFF(DAY,b.Ymd,a.ymd)=1 then a.ymd end) as online1,
                ...
                FROM `{$this->_realTableName}` as a LEFT JOIN stat_install_uuid_qid_only as b on a.uid=b.uid and a.qid=b.QID
