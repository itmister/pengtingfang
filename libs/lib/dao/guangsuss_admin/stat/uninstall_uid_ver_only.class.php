...
use \Dao;
class Uninstall_uid_ver_only extends \Dao\Guangsuss_admin\Guangsuss_admin {
    ...
    public function get_uninstall_rate($ymd){
        $sql = "SELECT b.Ymd as ymd,a.ver as ver,count( case when TIMESTAMPDIFF(DAY,b.Ymd,a.Ymd)=1 then a.Ymd end) as uninstall1,
