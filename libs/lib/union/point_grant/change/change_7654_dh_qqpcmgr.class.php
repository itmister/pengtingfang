 ...
 * 原始渠道号转换uid
 */
class Change_7654_dh_qqpcmgr extends Change{

    protected static $_instance = null;
    private static $_changeSoftId = "qqpcmgr_dh";//取渠道号的softId
    private static $_getDataSoftId = "";//取数据的softId

    /**
     * @return \Union\Point_grant\Change\Change_7654_dh_qqpcmgr
     */
    ...
    public function get_data_to_vendor_org($softId,$ymd){
        ...
        $data = \Dao\Union\Vendor_Org_Data::get_instance()->select(
            array(
                "where"=>"promotion='{$softId}' and ymd={$ymd} and org_id like '7654qg_%'",
