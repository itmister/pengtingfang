 ...
 * 原始渠道号转换uid
 */
class Change_qqpcmgr_dh extends Change{

    protected static $_instance = null;
    private static $_changeSoftId = "";//取渠道号的softId
    private static $_getDataSoftId = "qqpcmgr";//取数据的softId

    /**
     * @return \Union\Point_grant\Change\Change_qqpcmgr_dh
     */
    ...
    public function get_data_to_vendor_org($softId,$ymd){
        ...
        $data = \Dao\Union\Vendor_Org_Data::get_instance()->select(
            array(
                ...
                "field"=>"RIGHT(org_id,5) as org_id,count,active_count"
            )
        );
        return $data;
    }
