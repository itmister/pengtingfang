 ...
 * 原始渠道号转换uid
 */
class Change_qqbrowserv2 extends Change{
    ...
    public function org_id_change_my_org_id($array){
        ...
        foreach($array as $_v){
            ...
            if(intval($_v['org_id'])<125000000) continue;
            $_v['org_id'] = $_v['org_id'] - 125000000;
            $_v['org_id'] = str_pad($_v['org_id'],5,"0",STR_PAD_LEFT);
